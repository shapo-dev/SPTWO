...
{block name="frontend_index_checkout_actions_notepad"}
    <li class="navigation--entry entry--notepad" role="menuitem">
        ...
        <a href="{url controller='note'}" title="{$snippetIndexLinkNotepad|escape}" class="btn">
            ...
            {/if}
            <span class="heart--display">{$snippetIndexLinkNotepad|escape}</span>
        </a>
    </li>
{/block}
        ...
        {block name="frontend_index_checkout_actions_account"}
            <a href="{url controller='account'}"
               ...
               <i class="ti ti-user"></i>
                ...
                <span class="account--social-profile"><img src="https://graph.facebook.com/${id}/picture?type=large" alt="{$s_user_attributes.facebook_identity}"></span>
